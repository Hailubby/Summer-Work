...
$(document).ready(function () {
    ...
    $("#start-button-1a").click(function () {
        ...
        $("#d1a-pointer-top").removeClass("stack-pointer-top");
        $("#d1a-pointer-bot").removeClass("stack-pointer-bottom");
        p1_c1_hideBorders();
    ...
    var p1_c1_line2 = function () {
        ...
        setTimeout(function(){
            $("#d1a-pointer-top").addClass("stack-pointer-top");
            $("#d1a-pointer-bot").addClass("stack-pointer-bottom");
        }, 800);
    ...
    $("#start-button-1c").click(function () {
        ...
        $("#d1c-pointer-top1").removeClass("stack-pointer-top");
        $("#d1c-pointer-bot1").removeClass("stack-pointer-bottom");
        $("#d1c-pointer-top2").removeClass("stack-pointer-top");
        $("#d1c-pointer-bot2").removeClass("stack-pointer-bottom");
        p1_c3_hideBorders();
    ...
    var p1_c3_line2 = function () {
        ...
        setTimeout(function(){
            $("#d1c-pointer-top1").addClass("stack-pointer-top");
            $("#d1c-pointer-bot1").addClass("stack-pointer-bottom");
        }, 800);
    ...
    var p1_c3_line3 = function () {
        ...
        setTimeout(function(){
            $("#d1c-pointer-top2").addClass("stack-pointer-top");
            $("#d1c-pointer-bot2").addClass("stack-pointer-bottom");
        }, 800);
    ...
    $("#start-button-2a").click(function () {
        ...
        $("#d2a-faveNum-val").animate({backgroundColor: 'transparent'}, 0);
        ...
        $("#d2a-rtn-addr-val").promise().done(function () {
            ...
            $("#d2a-heap-faveNum-val1").promise().done(function () {
                p2_c1_line3();
                $("#d2a-mem-leak1").promise().done(function () {
                    p2_c1_line4();
                    $("#d2a-mem-leak2").promise().done(function () {
                        p2_c1_line5();
                    });
                });
            });
    ...
    var p2_c1_line3 = function () {
        ...
        $("#d2a-faveNum-val").delay(1000).animate({backgroundColor: '#d1d1d1'}, 500);
        setTimeout(function(){
            $("#d2a-faveNum-val").html('0x001d54f4');
        }, 1900);
        $("#d2a-heap-faveNum-val2").delay(2100).show(400);
        $(".d2a-heap1").delay(2500).animate({backgroundColor: '#dd747b'}, 700);
        $("#d2a-mem-leak1").delay(3200).show(400);
    };
    ...
    var p2_c1_line4 = function () {
        ...
        $("#d2a-faveNum-val").animate({backgroundColor: 'transparent'}, 1000);

        $("#d2a-rtnval-val").delay(1000).show(400);
        $(".d2a-heap2").delay(1400).animate({backgroundColor: '#dd747b'}, 700);
        $("#d2a-mem-leak2").delay(2100).show(400).delay(400);
    };
    ...
    var p2_c1_line5 = function () {
        ...
        $("#code2a-line-5").promise().done(function () {
            p2_c1_hideBorders();
            $("#d2a-pointer-top").removeClass("stack-pointer-top");
            $("#d2a-pointer-bot").removeClass("stack-pointer-bottom");
        });
    ...
    $("#code2a-line-4").click(function(){
        ...
        $("#d2a-faveNum-val").animate({backgroundColor: '#d1d1d1'}, 0);
    ...
    $("#code2a-line-5").click(function(){
        ...
        $("#d2a-faveNum-val").animate({backgroundColor: 'transparent'}, 0);
        $(".table .d2a-heap1").animate({backgroundColor: '#dd747b'}, 0);
        $(".table .d2a-heap2").animate({backgroundColor: '#dd747b'}, 0);
        $("#d2a-pointer-addr1").animate({color: '#777'}, 0);
        $("#d2a-pointer-addr2").animate({color: '#532A78'}, 0);
        $("#d2a-pointer-top").addClass("stack-pointer-top");
        $("#d2a-pointer-bot").addClass("stack-pointer-bottom");
    ...
    var p2_c2_line2 = function () {
        ...
        $(".table .d2b-heap1").delay(1200).animate({backgroundColor: '#D5D5D5'},500);
    ...
    var p2_c2_line3 = function () {
        ...
        $("#d2b-faveNum-val").delay(1000).animate({color: '#777', fontWeight: 'bold'}, 150);
        $(".table .d2b-heap1").delay(1000).animate({backgroundColor: 'transparent'},500).delay(700);
    };
    ...
    var p2_c2_line4 = function () {
        ...
        $("#d2b-faveNum-val").delay(1000).animate({backgroundColor: '#d1d1d1'}, 500);
        setTimeout(function(){
            $("#d2b-faveNum-val").html('0');
        }, 1900);
        $("#d2b-faveNum-val").delay(1900).show(400);
    };
    ...
    var p2_c2_line5 = function () {
        ...
        $("#d2b-faveNum-val").animate({backgroundColor: 'transparent'}, 1000);
    ...
    $("#code2b-line-2").click(function(){
        ...
        $(".d2b-hide-all").hide();
        $(".table .d2b-heap1").animate({backgroundColor: 'transparent'}, 0);
        $("#d2b-faveNum-val").animate({backgroundColor: 'transparent'}, 0);
        $("#d2b-pointer-addr").animate({color: '#777'}, 0);
    ...
    $("#code2b-line-5").click(function(){
        ...
        $("#d2b-faveNum-val").html("0");
        $("#d2b-faveNum-val").animate({color: '#777', fontWeight: 'bold'}, 0);
        $("#d2b-faveNum-val").animate({backgroundColor: '#d1d1d1'}, 0);
    ...
    $("#start-button-2c").click(function () {
        currentLine2c = 1;
        $(".d2c-hide-all").hide();
        $(".d2c-hide-all-heap").hide();
        $("#d2c-pointer-top").removeClass("stack-pointer-top");
        $("#d2c-pointer-bot").removeClass("stack-pointer-bottom");
        p2_c3_hideBorders();
        $(".d2c-link").animate({backgroundColor: 'transparent'}, 0);
        $(".table .d2c-heap1").animate({backgroundColor: 'transparent'}, 0);
        $(".table .d2c-heap2").animate({backgroundColor: 'transparent'}, 0);
        $("#d2c-faveNum-val").animate({backgroundColor: 'transparent'}, 0)
                ...
                $(".table .d2c-heap1").promise().done(function () {
                    ...
                    $("#d2c-faveNum-val").promise().done(function () {
                        ...
                        $("#d2c-heap-faveNum-val2").promise().done(function () {
                            p2_c3_line6();
                            $("#d2c-mem-leak").promise().done(function () {
                                p2_c3_line7();
                            });
                        });
                    });
    ...
    var p2_c3_line2 = function () {
        ...
        setTimeout(function(){
            $("#d2c-pointer-top").addClass("stack-pointer-top");
            $("#d2c-pointer-bot").addClass("stack-pointer-bottom");
        }, 800);

        $("#d2c-faveNum").delay(1000).show(400);
        $(".table .d2c-heap1").delay(1200).animate({backgroundColor: '#D5D5D5'},500);
    ...
    var p2_c3_line3 = function () {
        ...
        $("#d2c-faveNum-val").delay(1000).animate({color: '#777', fontWeight: 'bold'}, 150);
        $(".table .d2c-heap1").delay(1000).animate({backgroundColor: 'transparent'},500).delay(700);
    };
    ...
    var p2_c3_line4 = function () {
        ...
        $("#d2c-faveNum-val").delay(1000).animate({backgroundColor: '#d1d1d1'}, 500);
        setTimeout(function(){
            $("#d2c-faveNum-val").html('0');
        }, 1900);
        $("#d2c-faveNum-val").delay(1900).show(400);
    };
    ...
    var p2_c3_line5 = function () {
        ...
        $("#d2c-faveNum-val").animate({backgroundColor: 'transparent'}, 500).delay(500).animate({backgroundColor: '#d1d1d1'}, 500);
        setTimeout(function(){
            $("#d2c-faveNum-val").html('0x001d54fc');
            $("#d2c-faveNum-val").animate({color: '#532A78', fontWeight: 'bold'}, 150);
        }, 1800);
        $(".table .d2c-heap2").delay(2000).animate({backgroundColor: '#D5D5D5'},500);
        $("#d2c-pointer-addr2").delay(2500).animate({color: '#532A78', fontWeight: 'bold'}, 150);
        $("#d2c-heap-faveNum-val2").delay(2700).show(400);
    };
    ...
    var p2_c3_line6 = function () {
        ...
        $("#d2c-faveNum-val").animate({backgroundColor: 'transparent'}, 1000)

        $("#d2c-rtnval-val").delay(1000).show(400);
        $(".d2c-heap2").delay(1400).animate({backgroundColor: '#dd747b'}, 700);
        $("#d2c-mem-leak").delay(2100).show(400).delay(400);
    };

    //p2 c3 line 7 function
    var p2_c3_line7 = function () {
        $("#code2c-line-6").animate({backgroundColor: 'transparent'}, 1000);
        $("#code2c-line-7").animate({backgroundColor: '#ffff00'}, 1000);

        $(".d2c-hide-all").delay(1000).hide(400);
        $("#code2c-line-7").promise().done(function () {
            p2_c3_hideBorders();
            $("#d2c-pointer-top").removeClass("stack-pointer-top");
            $("#d2c-pointer-bot").removeClass("stack-pointer-bottom");
        });
    ...
    var p2_c3_unhighlight = function () {
        ...
        $("#code2c-line-7").animate({backgroundColor: 'transparent'}, 0);
    };
    ...
    $("#code2c-line-5").click(function(){
        ...
        $("#d2c-faveNum-val").html("0");
        $("#d2c-faveNum-val").animate({color: '#777'}, 0);
        $("#d2c-faveNum-val").animate({backgroundColor: '#d1d1d1'}, 0);
        $("#d2c-pointer-top").addClass("stack-pointer-top");
        $("#d2c-pointer-bot").addClass("stack-pointer-bottom");
    ...
    $("#code2c-line-7").click(function(){
        $(".d2c-link").removeClass("yellow");
        $("#code2c-line-7").addClass("yellow");
    ...
    $("#step-button-2c").click(function () {
        ...
        else if (currentLine2c == 7) {
            //do line 7 things here
            $(".d2c-link").removeClass("yellow");
            p2_c3_line7();
            currentLine2c = 1;
        }
